...
/**
 * @dev MFET Lock contract give users free lock mechanism that with none payable function.
 *
 * Contract have no owner. Fell free to use this carbon free contract.
 *
 * Visit https://lock.mfet.earth to see how it works and use with a web interface.
 */
contract MFETLock is Context, ReentrancyGuard {
